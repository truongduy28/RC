    ...
    <footer className="footer">
      <div className="container">
        <Grid col={4} mdCol={2} smCol={1} gap={10}>
          ...
          <div>
            <div className="footer__title">Về {rootInfo.brandName}</div>
            <div className="footer__content">
          ...
          <div className="footer__about">
            <p>
              <Link to="/">
                <img src={rootInfo.logo} className="footer__logo" alt="" />
              </Link>
            </p>
            <p>
              Hướng đến mục tiêu mang lại niềm vui ăn mặc mới mỗi ngày cho hàng
              triệu người tiêu dùng Việt. Hãy cùng {rootInfo.brandName} hướng
